...
const Guide = () => {
  return (
    <div
      className="mx-2 mt-[4.9rem] mb-5 flex select-none flex-wrap items-center justify-center 
        gap-x-16 gap-y-4 rounded-lg border border-slate-300/10 bg-slate-900/50 px-8 py-2 
        text-lg text-slate-200 shadow-md sm:mx-4 md:mx-10"
    >
